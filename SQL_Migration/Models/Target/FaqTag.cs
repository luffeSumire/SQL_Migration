...
public partial class FaqTag
{
    public int FaqTagId { get; set; }

    public string FaqTagCode { get; set; } = null!;
    ...
    public virtual ICollection<FaqTagContent> FaqTagContents { get; set; } = new List<FaqTagContent>();
