...
-- 目標: Ecocampus.CampusSubmissions, CampusSubmissionContents, CampusSubmissionAttachments
-- 建立日期: 2025-08-06
-- 版本: v1.0 - 完整遷移腳本
-- ========================================
...
LEFT JOIN Ecocampus.dbo.Schools s ON s.SchoolCode = CASE 
...
SELECT 
    ...
    CASE 
        ...
        THEN (
            ...
            SELECT fe.Id 
            FROM Ecocampus.dbo.FileEntry fe 
